...
class BrowseAuthorizationTest extends TestCase
{
     ...
     */
    public function test_受講登録している資格の教材詳細画面は正常に200OKで閲覧できること(): void
    {
     ...
     */
    public function test_受講登録していない資格のPart詳細画面へ直リンクでアクセスした場合は厳格に403Forbiddenで遮断されること(): void
    {
        $response = $this->actingAs($this->student)
     ...
     */
    public function test_受講登録していない資格のChapter詳細画面へ直リンクでアクセスした場合は厳格に403Forbiddenで遮断されること(): void
    {
        $response = $this->actingAs($this->student)
     ...
     */
    public function test_受講登録していない資格のSection詳細画面へ直リンクでアクセスした場合は厳格に403Forbiddenで遮断されること(): void
    {
        $response = $this->actingAs($this->student)
