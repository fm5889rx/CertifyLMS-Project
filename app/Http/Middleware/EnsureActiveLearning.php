...
use App\Enums\UserStatus;       // B-B-16：追加
use Closure;
use Illuminate\Http\Request;
use Symfony\Component\HttpFoundation\Response;

/**
 * 受講中(in_progress)以外のユーザーをプラン機能から弾く Middleware。（B-B-16修正版）
 *
...
final class EnsureActiveLearning
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // B-B-16：学習状態によるアクセス制御の完全適合：
        // ログイン有無（null）のガードだけでなく、ユーザーの活動状態（status）をチェック
